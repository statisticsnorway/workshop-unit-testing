...
public class AssertIterableEqualsTest {
    ...
    void testAssertIterableEquals() {
        ...
        assertAll("Compare iterables",
                () -> assertIterableEquals(listOne, listTwo, () -> "Both lists should be equal"));
                //() -> assertIterableEquals(listOne, listThree, () -> "Both lists should be equal in content"),
                //() -> assertIterableEquals(listOne, listFour, () -> "Both arrays should be equal in ordering"));
    }
}
